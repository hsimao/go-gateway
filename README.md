...
- [gin_scaffold](#gin_scaffold)
  ...
  - [swagger 文档生成](#swagger%E6%96%87%E6%A1%A3%E7%94%9F%E6%88%90)
...
使用 gin 构建了企业级脚手架，代码简洁易读，可快速进行高效 web 开发。
主要功能有：

1. 请求链路日志打印，涵盖 mysql/redis/request
...
- 设置接口文档参考： `controller/demo.go` 的 Bind 方法的注释设置
